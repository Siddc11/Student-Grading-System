...
<title>SRMS</title>
<body>
<img src="first.png"  align="left"width="100" height="100">
<center><img src="nitbanner.png" width="600" height="100">
<img src="rslt.jpg" align="right"  width="100" height="100"></center>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="addNewStudent.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Enrollment Number</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Name</label>
                                    <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Operating Systems(OSY)</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Advanced Java Programming(AJP)</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Software Testing(STE)</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Client Side Scripting Lang.(CSS)</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Environmental Studies(EST)</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Industrial Training(ITR)</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Capstone Project Planning(CPP)</label>
                                    <div class="col-md-6">
...
<section>
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>Roll Number</th>
          <th>Operating Systems(OSY)</th>
          <th>Advanced Java Programming(AJP)</th>
          <th>Software Testing(STE)</th>
          <th>Client Side Scripting Lang.(CSS)</th>
          <th>Environmental Studies(EST)</th>
          <th>Industrial Training(ITR)</th>
          <th>Capstone Project Planning(CPP)</th>
        </tr>
      </thead>
    </table>
  </div>
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: If any discrepancy found in result or in software, contact Computer Department (NIT , POLY).
Designed & Developed by @Siddc</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @Navsahyadri Institute of Technology</h5></center> 
  <hr class="new1">
<br>
</body>
</html>